  ...
  return (
    <>
      <AuthRedirector>
        ...
        >
          <div>
            <h3 className={styles.addStdHead}>{`${firstName ?? ""}  ${
              lastName ?? ""
            }`}</h3>
          </div>
          <div>
            {/* <h5>LogOut</h5> */}
            <button onClick={userLogOut} className={styles.addStdHead}>
              LogOut
            </button>
          </div>
        </Box>
        ...
        <Box
          // component="form"
          className={styles.btnContainere}
          sx={{
            width: "100%",
        ...
        >
          ...
          <button
            ...
            onClick={UserChecked}
            className={checkin ? styles.checkoutBtn : styles.checkinBtn}
          >
            {checkin ? " Checked Out" : "Checked In"}
          </button>
        </Box>
      </AuthRedirector>
    </>
